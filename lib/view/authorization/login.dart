                ...
                Container(
                  ...
                  decoration:const BoxDecoration(
                    image: DecorationImage( 
                      image: AssetImage("assets/background/loginBG.jpg"),
                      fit: BoxFit.cover,
                    )
                  )
                ),
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                              ...
                              decoration:const InputDecoration(
                                ...
                                hintStyle: TextStyle(color: const Color.fromARGB(255, 232, 232, 232))
                              ),
                            ),
                          ),
                  ...
                  InkWell(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Login",style: TextStyle(fontFamily: 'sen',fontSize: 20)),
                        ),
                      ),
                    ),
                    onTap: ()async{
                      ...
                      //await controller.registerUser(userController.UserModel.value.name.toString(), userController.UserModel.value.phone.toString());
